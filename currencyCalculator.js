...
function calculateCurrency(){
        ...
        *********************************************************************************************/
         ...
         //Calculate the exchange rate and set the country prefix using a selection statement
                ...
                if (country == 0){ exchangeRate = usdAmount * AUD; countryName = "AUD";
                }else if(country == 1){ exchangeRate = usdAmount * AWG; countryName = "AWG";
                }else if(country == 2){ exchangeRate = usdAmount * BSD; countryName = "BSD";
                }else if(country == 3){ exchangeRate = usdAmount * XBT; countryName = "XBT"; 
                }else if(country == 4){ exchangeRate = usdAmount * GBP; countryName = "GBP";
                }else if(country == 5){ exchangeRate = usdAmount * CAD; countryName = "CAD";
                }else if(country == 6){ exchangeRate = usdAmount * CLP; countryName = "CLP";
                }else if(country == 7){ exchangeRate = usdAmount * CNY; countryName = "CNY";
                }else if(country == 8){ exchangeRate = usdAmount * CUP; countryName = "CUP";
                }else if(country == 9){ exchangeRate = usdAmount * DKK; countryName = "DKK";
                }else if(country == 10){ exchangeRate = usdAmount * EUR; countryName = "EUR";
                }else if(country == 11){ exchangeRate = usdAmount * EGP; countryName = "EGP";
                }else if(country == 12){ exchangeRate = usdAmount * HKD; countryName = "HKD";
                }else if(country == 13){ exchangeRate = usdAmount * IRR; countryName = "IRR";
                }else if(country == 14){ exchangeRate = usdAmount * NGN; countryName = "NGN";
                }//end of if else
        ...
        ***********************************************************************************************/                                                                                                               
        ...
        document.getElementById("currencyExchangeInfo").innerHTML = "The exchange rate for " + countryName + " is " + exchangeRate;
